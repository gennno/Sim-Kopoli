    ...
    public function index(Request $request)
{
    ...
    return view('ketua.dashboard', compact('countLakiLaki', 'countPerempuan', 'years', 'countSimpanan'));
}
...
public function status_prib()
{
    ...
    return view('ketua.status', ['pinjaman' => $pinjaman]);
}
...
public function data_pribadi()
{
    if (auth()->guard('anggota')->check()) {
        ...
        return view('/ketua/data_pribadi', ['anggotaData' => $anggotaData]);
    }
    ...
    public function store(Request $request)
{
    ...
    public function showDetailAnggota($id)
    {
        ...
        if ($anggota) {
            return view('ketua/detail_anggota', compact('anggota'));
        } else {
    ...
    public function showangsuran($id)
{
    ...
    return view('/ketua/angsuran', compact('data'));
}
public function showdetailangsuran($id)
{
    ...
    return view('ketua.detail_angsuran', compact('angsuran'));
...
public function angsuranStore(Request $request)
    ...
    public function biasa()
    {
        ...
        return view('ketua.PeminjamanBiasa', ['anggotaData' => $anggotaData]);
    }
    ...
    public function khusus()
    {
        $no_anggota = Auth::guard('anggota')->user()->no_anggota;
        $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
        return view('ketua.PeminjamanKhusus', ['anggotaData' => $anggotaData]);
    }
    ...
    public function urgent()
    {
        $no_anggota = Auth::guard('anggota')->user()->no_anggota;
        $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
        return view('ketua.PeminjamanUrgent', ['anggotaData' => $anggotaData]);
    }
    ...
    public function ketuapinjam(Request $request)
    {
        ...
        // Return a response
        return redirect()->route('ketua.status')->with('success', 'Peminjaman Berhasil diajukan.');
    }
