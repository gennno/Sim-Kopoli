            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav mt-4">
                        ...
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseAnggota" aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                            Anggota
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <div class="collapse" id="collapseAnggota" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                    data-bs-target="#collapsePinjam" aria-expanded="false"
                                    aria-controls="collapseLayouts">
                                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    Pinjaman
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                                <div class="collapse" id="collapsePinjam" aria-labelledby="headingOne"
                                    data-bs-parent="#collapseAnggota">
                                    <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('detail_pribadi_bendahara', ['id' => $data->no_anggota]) }}"
                                                class="btn btn-success">Detail</a>
                                        </td>
                                        <td>Rp.{{ number_format($data->total_simpanan, 0, ',', '.') }}</td>
                                        <td>
                                            <a href="{{ route('simpanan_pribadi_bendahara', ['id' => $data->no_anggota]) }}"
                                                class="btn btn-success">Detail</a>
                                        </td>
                                        <td>
                                            @if ($data->status == 'Aktif')
                                            <div
                                                style="background-color: #28a745; padding: 10px; width: 55px; border-radius: 5px;">
                                                <span style="color: #fff;">Aktif</span>
                                            </div>
                                            @elseif ($data->status == 'Tidak Aktif')
                                            <div
                                                style="background-color: #e43500; padding: 10px; width: 55px; border-radius: 5px;">
