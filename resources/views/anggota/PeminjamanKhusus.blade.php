        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid row justify-content px-4">
                    <h3 class="mt-4 mb-4 text-center">FORMULIR PERMOHONAN PINJAMAN KONSUMTIF KHUSUS</h3>
                    <hr style="height:3px;">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sec1">
                                    <p>Catatan : </p>
                                    <p>
                                        1.Formulir ini ditujukan untuk pinjaman >10 s/d 300 juta (sesuai kondisi kas KPB) yang akan diangsur maksimal 72 bulan</p>
                                        <p>2.Formulir ini wajib dilengkapi dengan ijazah asli dan transkrip nilai asli serta jaminan lain yang senilai dengan besaran pinjaman (misalnya BPKB motor/mobil, dan sebagainya).
                                    </p>
                                </div>
                                <hr>
