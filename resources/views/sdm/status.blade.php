                                        ...
                                        <tbody>
                                            @forelse($pinjaman as $index => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sdm.detail_PeminjamanBiasa', ['id' => $data->id]) }}" class="btn btn-primary">Detail</a>
                                                    </td>
                                                    <td >
                                                        ...
                                                        <div style="background-color: #0fcc5e; padding:8px; width: 85px; border-radius: 10px;">
                                                          ...
                                                          <td> <a href="{{ route('sdm.detail_angsuran', $data->id) }}" class="btn btn-primary">Detail</a></td>
