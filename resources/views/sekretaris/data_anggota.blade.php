                            ...
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('detail_pribadi_sekretaris', ['id' => $data->no_anggota]) }}" class="btn btn-success">Detail</a>
                                        </td>
                                        <td>Rp.{{ number_format($data->total_simpanan, 0, ',', '.') }}</td>
                                        <td>
                                            <a href="{{ route('simpanan_pribadi_sekretaris', ['id' => $data->no_anggota]) }}" class="btn btn-success">Detail</a>
                                        </td>
                                        <td>
