...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div class="container-fluid row justify-content px-4">
            <h1 class="mt-4 mb-4">Detail Simpanan</h1>
            <a href="{{ url('/sekretaris/data_anggota') }}" class="btn btn-success" style="width:80px;">Kembali</a>
            <p></p>
            <div class="card mb-4">
            ...
            <div class="card mb-4">
                        ...
                        <div class="card-body table-responsive">
                            <table id="datatablesSimple" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($monthlySavings as $savings)
                                        <tr>

                                            <td>Rp.{{ $savings['jumlah'] }}</td>
                                            <td>{{ $savings['bulan'] }}</td>
                                            <td>{{ $savings['tahun'] }}</td>
                                        </tr>
                                    @endforeach
