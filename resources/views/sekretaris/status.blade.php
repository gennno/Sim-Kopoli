        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid row justify-content px-4">
                    <h1 class="mt-4 mb-4">Data Pinjaman Anggota</h1>
                                        ...
                                        <tbody>
                                            @forelse($pinjaman as $index => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sekretaris.detail_PeminjamanBiasa', ['id' => $data->id]) }}" class="btn btn-primary">Detail</a>
                                                    </td>
                                                    <td >
                                                        ...
                                                        <div style="background-color: #0fcc5e; padding:8px; width: 85px; border-radius: 10px;">
                                                          ...
                                                          <td> <a href="{{ route('sekretaris.detail_angsuran', $data->id) }}" class="btn btn-primary">Detail</a></td>
                                                        ...
                                                        <div style="background-color: #e43500; padding:8px; width: auto; border-radius: 10px;">
                                                            <span style="color: #fff;">Memerlukan Persetujuan Bendahara</span>
                                                          </div>
