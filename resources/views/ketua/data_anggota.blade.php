        ...
        <ul class="navbar-nav ms-auto me-3">
            <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                    <li><button class="dropdown-item" type="button"><b>Halo, {{ Auth::guard('anggota')->user()->nama_lengkap; }} {{ Auth::guard('anggota')->user()->nama_lengkap; }}
                                </b></button></li>
                            ...
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('detail_pribadi', ['id' => $data->no_anggota]) }}" class="btn btn-success">Detail</a>
                                        </td>
                                        <td>Rp.{{ number_format($data->total_simpanan, 0, ',', '.') }}</td>
                                        <td>
                                            <a href="{{ route('simpanan_pribadi', ['id' => $data->no_anggota]) }}" class="btn btn-success">Detail</a>
                                        </td>
                                        <td>
