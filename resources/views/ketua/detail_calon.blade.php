        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid row justify-content px-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" style="width: 100%;" name="nik"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <img class="img-thumbnail" src="{{ asset('img/' . $data->foto) }}"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <img class="img-thumbnail" src="{{ asset('img/' . $data->foto_ktp) }}"
                                            style="width:150px;height:150px;" alt="Foto Anggota">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('img/' . $data->ttd) }}" style="width:150px;height:150px;"
                                            alt="Foto Anggota">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('img/' . $data->id_card) }}"
                                            style="width:150px;height:150px;" alt="Foto Anggota">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            Validasi Keanggotaan Koperasi
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('store.calon_anggota') }}"
                                enctype="multipart/form-data" onsubmit="return showPopup()">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="hidden" id="date" name="tanggal_gabung" value="">
                                        <input type="hidden" id="jumlah" name="jumlah" value="50000">
                                        <select name="status" id="status" style="display:none;">
                                            <option value="Aktif">Aktif</option>
                                        </select>
                                        <input type="hidden" class="form-control" style="width: 100%;" name="nik"
                                            value="<?php echo $data['nik']; ?>" s>
                                        <input type="hidden" id="date" name="tanggal_gabung" value="">
                                        <input type="submit" class="btn btn-success" name="submit" value="Terima"
                                            style="width:80px;">
                            </form>
                            <a href="" class="btn btn-danger" style="width:80px;">Tolak</a>
                        </div>
                    </div>
