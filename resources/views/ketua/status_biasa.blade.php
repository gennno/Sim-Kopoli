                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <div style="background-color: #0fcc5e; padding:8px; width: 85px; border-radius: 10px;">
                                                          ...
                                                          <td>
                                                            <a href="{{ route('ketua.angsuran', ['id' => $data->id]) }}" class="btn btn-warning">Angsuran</a>
                                                        </td>
                                                        <td> <a href="{{ route('ketua.detail_angsuran', $data->id) }}" class="btn btn-primary">Detail Angsuran</a></td>
